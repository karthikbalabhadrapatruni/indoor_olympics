...
export async function readAllData() {
  ...
  const insightRows = await safeReadSheet(sheets, "ai_insights!A2:K");
  ...
  const insights = insightRows.map(rowToAiInsight);
  ...
  return { users, gameTypes, sessions, scores, stats, access, insights };
}
